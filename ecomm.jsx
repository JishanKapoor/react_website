...
const Ecomm = () => {
  ...
  const content = {
    "Drive Sales": (
      <>
        Convert like crazy with Amazon listings that make customers click "Add
        to Cart!"
        <br />
        <br />
        Our sales-driven strategies ensure high conversion rates by optimizing
        product pages and promotions.
      </>
    ),
    "Amplify PPC Efforts": (
      <>
        Boost your keyword rankings for better visibility. Transform more PPC
        traffic into purchases.
        <br />
        <br />
        Our targeted PPC campaigns ensure you get the maximum ROI by constantly
        refining ad strategies and keyword targeting.
      </>
    ),
    "Minimize Return Rates": (
      <>
        Get the right buyers to keep your Amazon account healthy and your
        customers happy.
        <br />
        <br /> Our quality assurance practices reduce return rates by focusing
        on accurate product descriptions and high-quality imagery.
      </>
    ),
    "Improve Visibility": (
      <>
        Index and rank with the right balance of high-value search terms and
        customer-centric copy.
        <br />
        <br />
        Our SEO experts focus on improving your product's online visibility by
        leveraging targeted keywords and content strategies.
      </>
    ),
  };
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto p-6 mt-10">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 mb-6 md:mb-0 mt-5">
            <img
              src={S2}
          ...
          <div className="md:w-2/3 md:pl-6 mt-10">
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/2 mb-6 md:mb-0 border-r border-black">
                <ul className="space-y-10 text-3xl font-semibold">
